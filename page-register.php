...
if (!$user_ID) { 
    ...
    <main id="main" class="site-content">
        ...
        <h3>Vous n'avez pas de compte?<br /> S'enregistrer maintenant.</h3>
        <form action="" method="post" name="user_registeration">
            <p><label>Nom <span class="error">*</span></label></p>
            <p><input class="input" type="text" name="first_name" placeholder="" class="text" required /><br /></p>
            <p><label>Prénom <span class="error">*</span></label></p>
            <p><input class="input" type="text" name="last_name" placeholder="" class="text" required /><br /></p>
            <p><label>Email<span class="error">*</span></label></p>
            <p><input class="input" type="text" name="useremail" class="text" placeholder="" required /> <br /></p>
            <p><label>Pays <span class="error">*</span></label></p>
            <p><select id="country" name="country" class="form-control">
            ...
            <p><label>Mot de passe<span class="error">*</span></label></p>
            <p><input class="input" type="password" name="password" class="text" placeholder="" required /> <br /></p>
            <p><input class="btn" type="submit" name="user_registeration" value="S'inscrire" /></p>
            <a class="connect" href="<?=home_url() . "/login"?>">Déjà membre? Se connecter</a>
        </form>
        </div>
    </main>
    <?php 
        ...
        if (isset($_POST['user_registeration']))
        {
            ...
            if(empty( $first_name ) || empty( $useremail ) || empty($password))
            {
            ...
            if ( 1 > count( $reg_errors->get_error_messages() ) )
            {
                ...
                global $first_name, $last_name, $useremail;
